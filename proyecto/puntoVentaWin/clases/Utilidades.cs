...
namespace puntoVenta
{
    ...
    public  class utilidades
    {
        ...
        public  Boolean enviarCoreeoElectronico(string emisor,string destinatario,string asunto,string mensaje)
        {
            try
            {
                ...
                DataSet ds = utilidade.ejecutarcomando(sql);
        ...
        public  Boolean imprimirVentaRollo(string CodigoVenta)
        {
            try
            {
                if (CodigoVenta == null)
        ...
        private   void printDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                ds = utilidade.ejecutarcomando(sql);
        ...
        public   Boolean validarPermisoEmpleado(string codigoUsuario,string codigoPermiso)
        {
        ...
        public  string getNombreComprobanteFiscalById(string codigoTipoComprobante)
        {
        ...
        public  string getNombreByTercero(string codigo)
        {
            try
            {
        ...
        public  string GetIdMetodoPagoByNombre(string metodo)
        {
            try
            {
